...
const CurrentWeather = ({ data }) => {
  ...
  return (
    <div className="weather p-4">
      <div className="flex justify-around items-center">
        ...
        />
        <p className="ftext-8xl font-bold text-white temperature">{Math.round(data.main.temp)}&deg;</p>
      </div>
      <div>
  ...
  <div className="flex-1 text-center p-4 mt-2 font-bold bg-blue-600 shadow rounded-lg ">
    <span>Wind Speed</span>
    <span className="block font-normal">{data.wind.speed} mph</span>
  </div>
  <div className="flex-1 text-center p-4 mt-2 font-bold bg-green-600 rounded-lg">
    <span>Humidity</span>
